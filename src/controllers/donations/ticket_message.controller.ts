...
import { db } from '../../db';
import { TicketMessage, CreateTicketMessage } from '../../models/donations/ticket_message.model';
...
export class TicketMessageController {
  ...
  /**
   * Get messages for donation tickets specifically
   */
  ...
  /**
   * Delete a message (only for admin or message sender)
   */
