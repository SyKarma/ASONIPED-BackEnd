...
export const createOrUpdateDisabilityData = async (recordId: number, disabilityData: any): Promise<void> => {
  try {
    console.log('=== SAVING DISABILITY DATA ===');
    ...
    if (disabilityData.medical_additional?.biomechanical_benefit) {
      console.log('=== SAVING BIOMECHANICAL BENEFITS ===');
      console.log('Benefits:', disabilityData.medical_additional.biomechanical_benefit);
      ...
      for (const benefit of disabilityData.medical_additional.biomechanical_benefit) {
        console.log('Inserting benefit:', benefit);
        await db.query(
      ...
      console.log('No biomechanical benefits to save');
    }

    // Handle permanent limitations
    if (disabilityData.medical_additional?.permanent_limitations) {
      console.log('=== SAVING PERMANENT LIMITATIONS ===');
      console.log('Limitations:', disabilityData.medical_additional.permanent_limitations);
      ...
      for (const limitation of disabilityData.medical_additional.permanent_limitations) {
        console.log('Inserting limitation:', limitation);
        await db.query(
      ...
      console.log('No permanent limitations to save');
    }
