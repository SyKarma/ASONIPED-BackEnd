...
import * as PersonalDataModel from '../models/personal_data.model';
import { createOrUpdateCompletePersonalData } from '../models/complete_personal_data.model';
import { db } from '../../../db';
...
export const createAdminDirectRecord = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const recordId = await RecordModel.createRecord({
      record_number: `ADM-${Date.now()}`, // Generate admin record number
